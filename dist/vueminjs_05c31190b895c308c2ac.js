...
// load the styles
var content = __webpack_require__("dpBq");
...
module.exports = __webpack_require__("Nd1Q");
...
// load the styles
var content = __webpack_require__("eamH");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("26cc4486", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-d89bea78!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./list.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-d89bea78!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./list.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
(function (global, factory) {
    ...
    function flushSchedulerQueue() {
        ...
        for (index = 0; index < queue.length; index++) {
            ...
            has$1[id] = null;
            watcher.run();
            // in src dist, check and stop circular updates.
    ...
    function stateMixin(Vue) {
        ...
        // when using Object.defineProperty, so we have to procedurally dist up
        // the object here.
        var dataDef = {};
            ...
            if (!vm.$options.render) {
                vm.$options.render = createEmptyVNode;
                {
                    ...
                    if (vm.$options.template && vm.$options.template.charAt(0) !== '#') {
                        warn('You are using the runtime-only dist of Vue where the template ' + 'option is not available. Either pre-compile the templates into ' + 'render functions, or use the compiler-included dist.', vm);
                    } else {
    ...
    function canSkipNormalization(children) {
        for (var i = 0; i < children.length; i++) {
            var el = children[i];
            if (el.for || el.tag === 'template' || el.tag === 'slot' || el.if && el.ifConditions.some(function (c) {
                return c.tag === 'template';
            })) {
                return false;
            }
        }
        ...
        /* istanbul ignore if */
        {
            try {
                ...
                if (e.toString().match(/unsafe-eval|CSP/)) {
                    _warn('It seems you are using the standalone dist of Vue.js in an ' + 'environment with Content Security Policy that prohibits unsafe-eval. ' + 'The template compiler cannot work in this environment. Consider ' + 'relaxing the policy to allow unsafe-eval or pre-compiling your ' + 'templates into render functions.');
                }
            }
        }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-d89bea78", module.exports)
  }
}
...
/* styles */
__webpack_require__("MGJH")

var Component = __webpack_require__("VU/8")(
  /* script */
  __webpack_require__("vy2Q"),
  /* template */
  __webpack_require__("YrEP"),
  /* scopeId */
  null,
  /* cssModules */
  null
)
Component.options.__file = "/Users/didi/Documents/LSLoader/src/js/component/list.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-d89bea78", Component.options)
  } else {
    hotAPI.reload("data-v-d89bea78", Component.options)
  }
})()}
